...
import { NCollapse, NCollapseItem, NList, NListItem, NThing, NBadge, NTag, NSpace } from "naive-ui";
import type { IExtensionPreferences, UploadOverride } from "@/shared/types";
import { toTitleCase } from "@silveredgold/beta-shared";
import { ExperimentalOption } from "@silveredgold/beta-shared-components";
...
const props = withDefaults(defineProps<{ preferences: Partial<IExtensionPreferences>, extraCategory?: string }>(), {
